...
if($_POST){
    ...
    //Preparar la insercción de los datos PARA ACTUALIZAR
    ...
    //Asignando los valores que bienen del método POST(LOS QUE VIENEN DEL FORMULARIO) PARA ACTUALIZAR
    ...
    $cv=(isset($_FILES["cv"]["name"])?$_FILES["cv"]["name"]:"");
      ...
      //adjuntar CV- ACTUALIZAR CV EN EL ORDENADOR
    ...
    if($tmp_cv!=''){
        ...
        $registro_recuperado=$sentencia->fetch(PDO::FETCH_LAZY);
         ...
         //Borrar el archivo cv en i ordenador    
